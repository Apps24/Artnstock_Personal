...
const ArtDetails = () => {
  ...
  const getActiveFrameSizeList = async () => {
    const res = await httpClient.get("/frame_master/getActiveFrameMaster");
  ...
  const getActivePaperMasterList = async () => {
    const res = await httpClient.get("/paper_master/getActivePaperMasterList");
                ...
                <Tab.Panel>
                  ...
                  <div className="flex gap-x-7 flex-wrap w-[308px]">
                    {activePaperMasterList?.map((obj) => (
                      <div key={obj?.paperId} className="flex items-center">
