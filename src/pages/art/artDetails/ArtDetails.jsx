      ...
      <div className="w-w1168 mx-auto ">
        ...
        <div className="flex justify-center gap-[30px]">
          ...
          <div>
            ...
            <button className="text-[#F88331] text-[12px]">See all customer images</button>
          </div>
        </div>
      </div>


      <div className="w-w1168 h-[726px] mt-[95px] rounded-2xl mx-auto shadow-dropShadow">
      </div>
      <p className="w-w1168 mx-auto flex justify-between text-[#F88331] text-[12px] mt-2 mb-10">
        <span>Disclosures & Guidlines</span><span>See all 126 reviews</span>
      </p>
      <Footer />
    </>
  );
