...
const MailingAdd = () => {
  ...
  const updateAddress = () => {
    ...
    mailingAddressModel.shippingAddress.addressLine1 = values.addressOne
    mailingAddressModel.shippingAddress.addressLine2 = values.addressTwo
    ...
    httpClient.put("/user_master/updateShippingAddress", mailingAddressModel)
    .then((res) => {
      // console.log(res);
      if(res.data){
        ...
        <div className="right flex-1 pl-[15px] pr-[20px] pt-[1.563rem]">
          ...
          <div className=" mb-4">
            ...
            {userType.userType === "customer" ? (
              ...
              <div className="flex">
                ...
                <Stepper tabNo="2" tabBgColor="#BBBBBB" tabColor="#333333" />
                <Stepper tabNo="3" tabBgColor="#eeeeee" tabColor="#757575" />
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-0.5 flex items-center">
              <p className="regHeading mr-1">Enter Your Mailing Address </p>
            ...
            <input
              ...
              <button type="submit" className="blackBtn mt-[0.938rem]">Next</button>
          </form>
        </div>
      </div>
    </div>
