      ...
      <div className='w-[100%] flex justify-center pt-[15px]'>
        <div className='w-w1170 flex justify-between'>
          <div className='max-w-[197.09px] mt-[10px]'>
            <p className='text-[25px] font-medium'>Rejected Files</p>
              ...
              <div className='w-[570px]'>
                ...
                <table className='table mt-[20px] w-[570px] h-[197px] border-separate border-spacing-0'>
                  <tbody>
                    ...
                    <tr>
                      <td className='border-b border-r border-l text-[13px] rounded-bl-[8px] pl-[6px] border-[#dddddd] bg-[#f7f7f7] text-primaryBlack font-medium'>
                        Date Reviewed
                      </td>
                      <td className='border-b border-r text-[13px] rounded-br-[8px]  text-primaryGray border-[#dddddd] pl-[6px]'>
                        06/01/2022
                      </td>
                    </tr>
                  </tbody>
