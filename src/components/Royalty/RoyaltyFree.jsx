            ...
            <div className=" flex gap-4 mt-6 text-center text-[#ffffff]">
              <div className="card">
                ...
                >
                  ...
                  >
                    <div>
                      <p className="font-semibold text-[38px]">Photos</p>
                      <p className="text-[12px] font-medium leading-3.5">
                        Finding stories in a spill of colours, <br />
                        memories captured
                      </p>
                      <p className="text-[38px] font-thin">86450+</p>
                      <img
                        src={vector}
              ...
              <div className="card">
                ...
                >
                  ...
                  >
                    <div>
                      <p className="font-semibold text-[38px]">Footage</p>
                      <p className="text-[12px] font-medium leading-3.5">
                      Infinite photos in continuous broadcast, <br /> past experiences relived in playback
                      </p>
                      <p className="text-[38px] font-thin">8450+</p>
                    </div>
                    <img
                      src={IFootage}
                      className="absolute bottom-2.5 left-2.5"
              ...
              <div className="card">
                ...
                >
                  ...
                  >
                    <div>
                      <p className="font-semibold text-[38px]">Music</p>
                      <p className="text-[12px] font-medium leading-3.5">
                      Instrument plays a melodious trance, <br /> symphonies creating heartful romance
                      </p>
                      <p className="text-[38px] font-thin">9850+</p>
                    </div>
                    <img
                      src={IMusic}
                      className="absolute bottom-2.5 left-2.5"
