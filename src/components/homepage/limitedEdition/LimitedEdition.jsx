...
const LimitedEdition = ({ logo, type }) => {
  ...
  return (
    <div className="w-w1440 mx-auto text-center">
      ...
      <img src={limitedList?.headingImage} className="mx-auto my-2.5" alt="" />
      ...
      <img src={limitedList?.newText} className="mx-auto mt-5 mb-1" alt="" />
      <img src={limitedList?.merchTextImg} className="mx-auto" alt="" />
      <img src={limitedList?.mainImage} className="mx-auto mt-4 mb-5" alt="" />
      <button className="blackBtn mx-auto block">Discover More</button>
