        ...
        return (
          <div className="relative" key={data?.bannerId}>
            ...
            <div className="absolute left-24 z-10 top-12">
              ...
              <p className="text-[2.375rem] font-semibold leading-[40px] w-[500px] text-primaryBlack">
                {data?.bannerLeftDescription}
              </p>
              <button className="blackBtn my-4">Discover Collections</button>
            ...
            <div className="absolute right-24 z-10 top-14">
              ...
              <p className="text-[15px] font-semibold leading-[22px] text-primaryBlack mt-1">{data?.offerText}</p>
              <p className="text-sm11 text-primaryBlack mb-1">{data?.offerDesc}</p>
              <button className="bg-pinkColor text-sm12 text-primaryBlack font-semibold rounded-2xl py-1 px-2">Shop with 20% Off</button>
