    ...
    <>
      <div className="wrapper ">
        ...
        <div className="flex justify-center">
          <div >
          <p className="text-center text-[18px] text-[#ff369f] mt-10">OOPS... Something is not right.</p>
          <ul className="pt-[11px] pb-[14px] px-5 list-disc text-[12px] mt-[15px] mb-8 text-[#ff369f] border border-[#ffd7ec] rounded-2xl">
            <li className=" ">
              <p>You must enter a BILLING FIRST NAME.</p>
            </li>
            <li>
              <p>You must enter a BILLING LAST NAME.</p>
            </li>
            <li>
              <p>You already have an account with Artnstock using an Email address ksgrafiks2012@gmail.com.</p>
            </li>
            <li>
              <p>Please LOGIN before completing your order.</p>
            </li>
            <li>
              <p>You must enter a PHONE NUMBER.</p>
            </li>
            <li>
              <p>You must enter a BILLING ADDRESS.</p>
            </li>
          </ul>
          </div>
        </div>
