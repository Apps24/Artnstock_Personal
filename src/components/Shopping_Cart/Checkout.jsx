          ...
          <div className='w-[35.625rem]'>
            <div className='flex items-center'>
              ...
              <p className='text-[12px] text-[#757575] leading-[1.2]'>
                ...
                method will be saved for future orders. <br /> Manage
                your payment methods in your{' '}
            ...
            <div>
              ...
              <label
                htmlFor=''
                className='text-[12px] text-[#757575] leading-[1]'
              >
                Card Type
              </label>
              <input
            ...
            <div>
              ...
              <div>
                ...
                <div className='mb-0'>
                  <label
                    htmlFor=''
                    className='text-[12px] mt-[13px] mb-0 text-[#757575]  leading-[1]'
                  >
                    First Name
                  </label>
                  <input
              ...
              <div>
                ...
                <p className='text-[11px] text-[#757575] mt-[13px] mb-[26px] leading-[1.2]'>
                  ...
                  times. Please note - your government may charge an
                  import tax on products received from outside your
              ...
              <div className='bg-[#f9f9f9]'>
                <div className='mx-[15px]'>
                  <div className='pt-[10px] pb-[40px] text-center bg-[url()]'>
                    <p className='text-[12px] font-medium border rounded-full px-[15px] py-[8px] leading-[1.2]'>
                  ...
                  <div className='flex gap-2'>
                    ...
                    <div>
                      ...
                      <p className='text-[#757575] text-[12px] flex gap-[10px] mb-[20px] leading-[1]'>
                        <span>Edit</span>
                        <span>Delete</span>
                  ...
                  <div className=' border-y-4 pt-[18px] border-[#808080]'>
                    ...
                    <div className='flex justify-between items-center border-t-2 border-[#808080] pt-[12px] pb-[10px]'>
                      ...
                      <div className='text-[#F9944C] leading-[1.2]'>
                        <p>
                          ${' '}
                          <span className='text-[35px]'>267.89</span>{' '}
                        </p>
                        <p className='mt-0 pt-0 text-[#757575] text-[12px]'>
                          Show Price Details
                        </p>
                      </div>
                    </div>
                  ...
                  <div>
                    <div className='my-[17px] text-[#757575] flex gap-[7px]'>
                      <input type='checkbox' />
                    ...
                    <div className='bg-[#ffffff] mt-[10px]  px-[10px] pb-[14px] shadow-[0px_2px_8px_0px_rgba(99,99,99,0.2)] rounded-2xl flex justify-center'>
                      <div>
                        ...
                        <div className='pt-[10px]'>
                          ...
                          <ul className='text-[9pt] text-[#878787] leading-[1.4]'>
                            <li>
