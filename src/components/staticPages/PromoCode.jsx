    ...
    <>
      ...
      >
        <div>
          ...
          <p className='text-[64px] text-[#ffffff] opacity-70'>
            Promocode
          </p>
          <div className='bg-[#ffffff] mt-[25px] rounded-2xl py-[32px] '>
            <p className='text-[38px] text-[#333333] leading-tight'>
              Download Photos and save <br /> with your Artnstock
              Promocode
            </p>
            <p className='text-[13px] mt-[18px] text-[#333333]'>
              Get creative without busting your budget when
              downloading images with us. <br /> Use our exclusive
              promo code now to enjoy some savings.
            </p>
            ...
            <div className=' bg-[#cdfd35] rounded-2xl px-5 pb-5 mx-[120px] mt-5'>
              <div className='flex gap-[13px] justify-center items-center'>
                ...
                <div className='text-[#333333] text-[15px]'>
                  An exclusive <br /> welcome offer on your <br />{' '}
                  first order
                  <p>
              ...
              <p className='text-[#535353] text-[12px]'>
                *Offer is available to new customer only. Applicable
                for one-time, online purchase only. <br />
                Cannot be combined with other offers. Excludes
                Exclusive, <br /> Limited Edition and Auction Arts.
              </p>
            </div>
          </div>
        </div>
