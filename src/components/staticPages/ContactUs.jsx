    ...
    <div className="wrapper">
      <main>
        ...
        <div className="mt-[30px]">
          <p className="bullet text-center mb-1">Artnstock / Contact</p>
          ...
          <div className="flex justify-center ">
            <p className="text-[12px] mt-[18px] text-[#333333] text-center">
              ...
              <span className="text-[#FF7A6D]">support center</span>. If not,
              send us a message. <br /> We'll get back to you within 24 hrs.
            </p>
          </div>
        </div>
          ...
          <div className="w-w450">
            <form action="">
              ...
              <textarea
                ...
                cols=""
                rows=""
                className="outline-none border border-[#757575] h-[118px] w-[100%] rounded-3xl resize-none mt-[7px] p-4"
              ></textarea>
              <label
                htmlFor=""
