          ...
          >
            <div className="z-50  flex justify-center text-center text-[#ffffff]">
              <div className="mt-[63px] mb-[68px]">
                <p className="text-[75px] text-[#333333] font-semibold leading-[1]">ABOUT US</p>
                ...
                <p className="text-[18px] text-[#333333] font-medium">Passion is Vision</p>
              </div>
            </div>
          </div>
          <div>
            ...
            <p className="text-center font-medium  text-[38px] text-[#333333] mt-1.5 mb-5 leading-[1.1]">
              We bring creative empowerment <br /> to every creative community
            </p>
            <p className="flex h-[658px] w-w1168 justify-center mx-auto mt-[25px]">
            <iframe width="100%" height="100%" className="rounded-2xl" src="https://www.youtube.com/embed/kw4tT7SCmaY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </p>
            <div className="text-center">
              ...
              <p className="mt-[10px] mb-[25px] text-[#757575] text-[14px]">
                At Artnstock we aim at bringing together the artists of today
                from across the world and giving them a platform to display
                their passion in different <br /> forms ranging from paintings
                to videos and create a home where creativity is encouraged and
                transpired into great works of design. Our objective <br /> with
                this website is to bring to the world’s creative minds a
                platform where they can develop and use creativity in the way
                that suits you. We are here <br /> to generate global designs
                with a touch of desi (tadka) in it. A market that aims at
                bringing the world together through creations of the innovative{" "}
                <br /> mind. A market that fuels the creative energy residing
            ...
            <div className="flex justify-center gap-[30px] mt-[100px] mb-[278px]">
              ...
              <div className="text-[22px] text-[#757575]">
                <p className="leading-[1.2]">
                  Displaying cultures from across the globe to <br /> spectators
                  from all around the world.
                </p>
                <p className="mt-[34px] leading-[1.2]">
                  We give you our esteemed collectors, <br />
                  connoisseurs and astethe the true feeling of <br /> Midas
                  Touch!!! and owning one.
                </p>
                <p className="mt-[34px] leading-[1.2]">
