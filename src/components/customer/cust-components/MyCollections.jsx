...
// import styled from 'styled-components';
// // import AllFiles from '../contri-components/AllFiles';
// import AllFilesCust from './AllFilesCust';
...
//         </div>
//       </div>
//       <div className='w-[100%] flex justify-center pt-[25px]'>
//         <div className='w-[1410px] flex justify-between'>
//           <div className='max-w-[199.3px] mt-[10px]'>
//             <p className='text-[25px] font-medium'>
//               All Files{' '}
...
//             </div>
//           </div>
//           <div className='leading-[1] mt-[17px] flex gap-[20px]'>
//             <div className='flex gap-[10px]'>
//               <div>
//                 <button
//                   onClick={() => {
